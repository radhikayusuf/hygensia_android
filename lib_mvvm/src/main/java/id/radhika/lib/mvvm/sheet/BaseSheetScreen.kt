...
import id.radhika.lib.ui.component.LockableBottomSheetBehavior
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.viewTreeObserver.addOnGlobalLayoutListener {
            (dialog?.findViewById(RMaterial.id.design_bottom_sheet) as FrameLayout?)?.let { bottomSheet ->
                bottomSheet.layoutParams = CoordinatorLayout.LayoutParams(MATCH_PARENT, WRAP_CONTENT)
                (bottomSheet.layoutParams as CoordinatorLayout.LayoutParams).behavior =
                    LockableBottomSheetBehavior<CoordinatorLayout>()
